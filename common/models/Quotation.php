 ...
 * @property string|null $quotation_delivery_telephone
...
class Quotation extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['quotation_type', 'quotation_postal_code', 'quotation_project_category_id', 'quotation_product_amount', 'quotation_delivery_postal_code', 'created_user', 'modified_user'], 'integer'],
            ...
            [['quotation_telephone', 'quotation_tax_id', 'quotation_delivery_telephone'], 'string', 'max' => 20],
