...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><i class="icofont icofont-coins"></i> Contact From <small>List</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#"><i class="ti-home"></i> Home</a></li>
          <li class="breadcrumb-item active">Contact From List</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
    ...
    <div class="card">
      ...
      echo GridView::widget([
          ...
          'columns' => [
            ...
            [
                'attribute' => 'contact_form_first_name',
                'label' => 'First Name',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:180px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->contact_form_first_name.'</div>';
                },
            ],
            [
                'attribute' => 'contact_form_last_name',
                'label' => 'Last Name',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:180px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->contact_form_last_name.'</div>';
                },
            ],
            [
                'attribute' => 'contact_form_tel',
                'label' => 'Telephone',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->contact_form_tel.'</div>';
                },
            ],
            [
                ...
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->contact_form_message.'</div>';
                },
            ],
            [
              ...
              'buttons'  => [
                'View' => function ($url,$model) {
                  return Html::a('<span class="fa fa-eye" style="padding:0px 2px;"></span>','', [
                    ...
                    'title' => 'edit',
                    'data-toggle' => 'modal',
                    'value' => Url::to('contact-form/view/'.$model->contact_form_id),
                  ]);
                }
              ]
            ],
