...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><i class="icofont icofont-coins"></i> Article <small>List</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
          ...
          'columns' => [
            ...
            [
                ...
                'value' => function ($model) {
                    return '<img src="'.str_replace('/admin', '', Yii::getAlias('@web')).'/uploads/'.$model->article_image_path.'/'.$model->article_image.'" width="50">';
                },
            ],
            [
                'attribute' => 'article_name_th',
                'label' => 'Article Name (TH)',
                'format' => 'raw',
                // 'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->article_name_th.'</div>';
                },
            ],
            [
                'attribute' => 'article_name_en',
                'label' => 'Article Name (EN)',
                'format' => 'raw',
                // 'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->article_name_en.'</div>';
                },
            ],
            [
              ...
              'buttons'  => [
                'Update' => function ($url,$model) {
                  return Html::a('<span class="fa fa-edit" style="padding:0px 2px;"></span>','', [
                    ...
                    'title' => 'edit',
                    'data-toggle' => 'modal',
                    'value' => Url::to('article/update/'.$model->article_id),
                  ]);
                },
                'Delete' => function ($url, $model) {
                  return Html::a('<span class="fas fa-trash-alt" style="padding:0px 2px;"></span>', Url::to('article/delete/'.$model->article_id), [
                    'title' => 'delete',
                    'data-confirm' => Yii::t('yii', 'Are you sure you want to delete '.$model->article_id.' this item?'),
                    'data-method'  => 'post',
                    'data-pjax' => 1
                  ]);
                },
