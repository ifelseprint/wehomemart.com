...
<div class="content-header">
  <div class="container">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><i class="icofont icofont-coins"></i> Quotation <small>List</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
    ...
    <div class="card">
      ...
      echo GridView::widget([
          ...
          'columns' => [
            ...
            [
                'attribute' => 'quotation_code',
                'label' => 'Quotation Code',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:180px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->quotation_code.'</div>';
                },
            ],
            [
                'attribute' => 'quotation_firstname',
                'label' => 'First Name',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:180px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->quotation_firstname.'</div>';
                },
            ],
            [
                'attribute' => 'quotation_lastname',
                'label' => 'Last Name',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:180px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->quotation_lastname.'</div>';
                },
            ],
            [
                'attribute' => 'quotation_telephone',
                'label' => 'Telephone',
                'format' => 'raw',
                'contentOptions' => ['style' => 'width:120px'],
                'value' => function ($model) {
                    return '<div style="height: 25px;overflow:hidden;">'.$model->quotation_telephone.'</div>';
                },
            ],
            [
              ...
              'buttons'  => [
                'View' => function ($url,$model) {
                  return Html::a('<span class="fa fa-eye" style="padding:0px 2px;"></span>','', [
                    ...
                    'title' => 'edit',
                    'data-toggle' => 'modal',
                    'value' => Url::to('quotation/view/'.$model->quotation_id),
                  ]);
                }
              ]
            ],
